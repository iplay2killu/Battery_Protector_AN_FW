...
namespace GPIO
{
    bool GpioInput::_interrupt_service_installed{false}; // static member variable must be accessed with ::
    ...
    {
        int32_t pin = reinterpret_cast<int32_t>(args); // cast the void pointer to an integer pointer (can cast to any)
